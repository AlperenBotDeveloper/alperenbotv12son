...
exports.run = async (client, message, args) => {
  ...
  if(!hesapdurumu) {
    if(args[0]) return message.channel.send(`Bakmak istediğin kullanıcının bir hesabı bulunmamakta.`)
